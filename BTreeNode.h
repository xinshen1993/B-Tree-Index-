...
class BTLeafNode {
  ...
  public:
    static const int RECORDS_PER_NODE = (PageFile::PAGE_SIZE-sizeof(int)-sizeof(PageId))/(sizeof(int)+sizeof(RecordId));//number of (key,rid) each node
   /**
...
class BTNonLeafNode {
     friend class BTreeIndex;
  public:
    static const int RECORDS_PER_NonLeaf = (PageFile::PAGE_SIZE-sizeof(int)-sizeof(PageId))/(sizeof(int)+sizeof(PageId));
    static const int SizeN_RECORD=sizeof(int)+sizeof(PageId);
   /**
