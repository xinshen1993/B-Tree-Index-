...
class BTreeIndex {
 public:
  ...
  /**
    this is used to upate the rootpid and treeheight at the first page
  */
  void Update_rootpid_treeheight(PageId i, int j);
  /**
  ...
  /**
    this is used to recursive insert when spliting the node
  */
  void recursive_insert(PageId pid, int recursive_key);
